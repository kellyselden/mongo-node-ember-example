...
(function () {
  ...
  var defaultConfiguration = {
    ...
    cloneClicks: false,
    // For single-page apps that use History API.
    // Anchor tags with href don't cause redirect, so don't reload page
    reloadAfterClonedClick: true,
